...
const config = {
  ...
  paths: {
    rootFolder,
    distFolder: path.join(rootFolder, 'dist/library'),
    npmFolder: path.join(rootFolder, 'node_modules/@terminus/ui'),
    scss: {
      helpersInputs: [
        // NOTE: Keep custom properties first in line:
        path.join(rootFolder, 'projects/library', 'scss/global/_custom-properties.scss'),
        path.join(rootFolder, 'projects/library', 'scss/a11y/_a11y.scss'),
        path.join(rootFolder, 'projects/library', 'scss/animation/_animation.scss'),
        path.join(rootFolder, 'projects/library', 'scss/breakpoints/_breakpoints.scss'),
        path.join(rootFolder, 'projects/library', 'scss/color/_color.scss'),
        path.join(rootFolder, 'projects/library', 'scss/cursors/_cursors.scss'),
        path.join(rootFolder, 'projects/library', 'scss/layout/_center-content.scss'),
        path.join(rootFolder, 'projects/library', 'scss/layout/_opposite-direction.scss'),
        path.join(rootFolder, 'projects/library', 'scss/layout/_pseudo.scss'),
        path.join(rootFolder, 'projects/library', 'scss/layout/_responsive-ratio.scss'),
        path.join(rootFolder, 'projects/library', 'scss/layout/_take-space.scss'),
        path.join(rootFolder, 'projects/library', 'scss/layout/_visually-hidden.scss'),
        path.join(rootFolder, 'projects/library', 'scss/scrollbars/_scrollbars.scss'),
        path.join(rootFolder, 'projects/library', 'scss/shadows/_shadows.scss'),
        path.join(rootFolder, 'projects/library', 'scss/spacing/_spacing.scss'),
        path.join(rootFolder, 'projects/library', 'scss/triangle/_triangle.scss'),
        path.join(rootFolder, 'projects/library', 'scss/typography/_typography.scss'),
        path.join(rootFolder, 'projects/library', 'scss/utilities/_utilities.scss'),
        path.join(rootFolder, 'projects/library', 'scss/z-index/_z-index.scss'),
        // Card must be after spacing and shadows
        path.join(rootFolder, 'projects/library', 'scss/card/_card.scss'),
      ],
      globalStylesInput: path.join(rootFolder, 'projects/library', `scss/global/terminus-ui.scss`),
    },
  },
  sass: {
    shared: {
