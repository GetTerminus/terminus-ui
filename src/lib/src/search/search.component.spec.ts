...
describe('TsSearchComponent', () => {
  ...
  describe(`emitSubmit()`, () => {
    ...
    beforeEach(() => {
      this.component.submitted.emit = jasmine.createSpy('emit');
    });
  ...
  describe(`keyup()`, () => {
    ...
    beforeEach(() => {
      this.component.changed.emit = jasmine.createSpy('emit');
      this.component.debouncedEmit = jasmine.createSpy('debouncedEmit');
    });
