...
@Component({
  selector: 'demo-chart2',
  templateUrl: './chart2.component.html',
})
export class Chart2Component implements AfterViewInit {
  @ViewChild('chartComponent')
  public chartComponent!: TsChart2Component;
  public visualizationOptions: TsChart2VisualizationOptions[] = [
    'xy',
    'pie',
    'map',
    'radar',
  ...
  visualization: TsChart2VisualizationOptions = this.visualizationOptions[0];
  ...
  setChartData(chart: any, type: TsChart2VisualizationOptions) {
    /**
     * XY
     */
    if (type === 'xy') {
