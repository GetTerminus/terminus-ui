...
export class ChartComponent {
  ...
  setChartData(chart: TsChart, type: TsChartVisualizationOptions) {
    ...
    if (tsChartRadarTypeCheck(chart)) {
      ...
      const series2 = chart.series.push(new am4charts.RadarColumnSeries() as any);
      ...
      const series3 = chart.series.push(new am4charts.RadarColumnSeries() as any);
      ...
      const series4 = chart.series.push(new am4charts.RadarColumnSeries() as any);
      ...
      chart.scrollbarX = new am4core.Scrollbar() as any;
      chart.scrollbarY = new am4core.Scrollbar() as any;

      chart.cursor = new am4charts.RadarCursor() as any;
      chart.cursor.xAxis = categoryAxis;
      chart.cursor.fullWidthLineX = true;
      chart.cursor.lineX.strokeOpacity = 0;
      chart.cursor.lineX.fillOpacity = 0.1;
      chart.cursor.lineX.fill = am4core.color('#000000') as any;
    }
    ...
    if (tsChartTreeTypeCheck(chart)) {
      ...
      level2Column.stroke = am4core.color('#fff') as any;
      level2Column.strokeWidth = 5;
      level2Column.strokeOpacity = 1;

      const level2Bullet = level2.bullets.push(new am4charts.LabelBullet() as any);
      level2Bullet.locationY = 0.5;
      level2Bullet.locationX = 0.5;
      level2Bullet.label.text = '{name}';
      level2Bullet.label.fill = am4core.color('#fff') as any;

      /* Add a navigation bar */
      chart.navigationBar = new am4charts.NavigationBar() as any;
      chart.homeText = 'TOP';
    }
    ...
    if (tsChartSankeyTypeCheck(chart)) {
      ...
      nodeTemplate.nameLabel.label.fill = am4core.color('#fff') as any;
